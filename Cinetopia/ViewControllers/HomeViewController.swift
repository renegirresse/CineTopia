...
//  Cinetopia
//
//  Created by Rene Girresse on 17/03/24.
//
...
class HomeViewController: UIViewController {
    ...
    private lazy var logoImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage.logo2)
    ...
    private lazy var welcomeLabel: UILabel = {
        ...
        label.text = "The best place to search, save and organize your favorite movies!"
